...
rem  Config file : D:\ClaudeCode\cc-config.json
rem  Read script : D:\ClaudeCode\cc-config-read.ps1
rem
rem  Usage:
...
for /f "tokens=1,* delims=|" %%A in ('powershell -NoProfile -ExecutionPolicy Bypass -File "D:\ClaudeCode\cc-config-read.ps1" !CC_PROVIDER_ARGS!') do (
    set "%%A=%%B"
)
...
chcp 65001 >nul
if /I "%2"=="switch" (
    powershell -NoProfile -ExecutionPolicy Bypass -File "D:\ClaudeCode\cc-provider.ps1" -Action switch -Target %3
) else (
    powershell -NoProfile -ExecutionPolicy Bypass -File "D:\ClaudeCode\cc-provider.ps1" -Action list
)
goto end
...
:hist
chcp 65001 >nul
powershell -NoProfile -ExecutionPolicy Bypass -File "D:\ClaudeCode\cc-history.ps1"
goto end

:clear
chcp 65001 >nul
powershell -NoProfile -ExecutionPolicy Bypass -File "D:\ClaudeCode\cc-clear.ps1" %2
goto end
...
start "" pythonw.exe "D:\ClaudeCode\cc-ui-qt.py"
goto end

:backup
chcp 65001 >nul
powershell -NoProfile -ExecutionPolicy Bypass -File "D:\ClaudeCode\cc-backup.ps1" %2
goto end
...
chcp 65001 >nul
powershell -NoProfile -ExecutionPolicy Bypass -File "D:\ClaudeCode\cc-role.ps1" %*
goto end
...
echo ====================
echo   Config: D:\ClaudeCode\cc-config.json
echo.
...
echo     D:\ClaudeCode\cc-config.json
echo.
goto end
